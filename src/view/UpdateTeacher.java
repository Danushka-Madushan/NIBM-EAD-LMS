...
public class UpdateTeacher extends javax.swing.JDialog {
     ...
     */
    public UpdateTeacher(String id, String[] content) {
        this.id = id;
        initComponents();
        namefield.setText(content[0]);
        departmentfield.setText(content[1]);
        emailfield.setText(content[2]);
        phonefield.setText(content[3]);
    }
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        try {
            TeacherManagementController.updateTeacher(id, name, department, email, phone);
