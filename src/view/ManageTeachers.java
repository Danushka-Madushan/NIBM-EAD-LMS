...
public class ManageTeachers extends javax.swing.JFrame {
    ...
    public ManageTeachers() {
        initComponents();
        String[] selectedColumns = {"id", "name", "email", "department", "phone"};
        loadTableData("teachers", teacherTable, selectedColumns);
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (!e.getValueIsAdjusting()) {
                    ...
                    if (selectedRow != -1) {
                        ...
                        id = teacherTable.getValueAt(selectedRow, 0);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String[] data = TeacherManagementController.getTeacherDetailsById(Integer.parseInt(id.toString()));
        UpdateTeacher updateTeacher = new UpdateTeacher(id.toString(), data);
        updateTeacher.setLocationRelativeTo(null);
        updateTeacher.setModal(true);
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        if (result == JOptionPane.YES_OPTION) {
            // Perform the action
            TeacherManagementController.deleteUserByTeacherId(Integer.parseInt(id.toString()));
            String[] selectedColumns = {"id", "name", "email", "department", "phone"};
            loadTableData("teachers", teacherTable, selectedColumns);
        }
    }//GEN-LAST:event_btnRemoveActionPerformed

    public void addTeacherListener(ActionListener listener) {
